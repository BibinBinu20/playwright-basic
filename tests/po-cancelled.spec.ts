...
//       await line_add(page,1,"items001","BB_01_Supplier",5,2,"line","01/25/25");
//         await wait_for_ajax(page)
...
//         await line_add(page,2,"items002","BB_01_Supplier",3,5,"line","01/20/25");
//         await wait_for_ajax(page)
...
//   // await page.pause();
    ...
    //    await page.pause();
      ...
      await test.step("Reject Line 1", async () =>{
        await line_action(page,1,"reject",{reject_reason:"Out of stock"});
          });

          await test.step("Reject Line 2  ", async ()=>{
